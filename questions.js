...
const READER = {
  ...
  moralEnd: [
    "The Nature of your soul will tell us which element best suits you, the one you will learn the quickest. There are other forces of Magick, but souls of those natures are... not possible. Not for you. That is all I can share. Shall I read your soul now?",
  ],
  moralChoices: { other: "I want to know about the other forces.", yes: "Yes, go ahead." },
  meta: {
    header: "The Meta Forces of magick are those that bend, distort, and reinterpret reality and how it behaves.",
    lines: [
      { name: "Spacetime", text: "Spacetime is the magick of infinity. It is timeless, formless, and strange. It bends space, halts or hastens time, and exists beyond mortal capability; Like wielding a tool you're not capable of understanding. It can glimpse truths not meant for minds bound to flesh, offering mastery over the weave of existence itself or intoxicating madness in the face of eternity. It is not inherently good or evil, but neutral, uncaring, and terrifying in scale." },
      { name: "Mind", text: "Mind magick consists of thought, will, memory, and perception. Projecting influence and will onto the world, rewriting how others perceive reality, or how reality itself behaves. If Cosmic is the external fabric of reality, mind is the internal. Cosmic defines the stage of existence where Mind defines the lens through which existence is interpreted. Together, they bind the subjective and the objective; Both of which can be manipulated." },
    ],
  },
  metaChoice: "...",
  precreation: {
    ...
    lines: [
      { name: "Living Magick", text: "Wielded and understood only by omniscient, godlike beings. It is the raw, animating force of reality and life itself, the power that gives beings life, will, identity, and persistence in reality. The mortal plane itself cannot sustain unbound living magick." },
      { name: "Null Magick (Mu)", text: "Mu is not a force, but the absence that all forces are written into. Where fire transforms and the void consumes, Mu subtracts. Whatever it touches is simply unmade to reality. Null Magick feels like something beyond silence, emptiness that cannot be described as emptiness. It is impossible to cast or call upon Null Magick, for it cannot be given will. The user would have to invert a refined Ichor into a Hollow Ichor, inverting will upon itself, overwriting and releasing it. It is impossible to enter a state of resonance, as no matter aligns with its own deletion. To conjure Mu, one must feel emptiness beyond emptiness; A grief that has finished grieving, a sincere will that something end. Relinquishing possession, desire, punishment, replacement. Any flicker of emotion or wanting contaminates the inversion. Most mortal minds cannot structurally hold a genuine desire for nothingness." },
    ],
  },

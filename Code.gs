...
function doPost(e) {
  ...
  if (!sh) {
    ...
    sh.appendRow(["timestamp", "returnCode", "readingCode", "previousReturnCode", "handle", "soul", "magnitude",
      "F", "W", "E", "A", "R", "V", "blood_b", "blood_d", "secondsTaken", "baseline", "picks", "ua"]);
  }
  const d = JSON.parse(e.postData.contents);
  sh.appendRow([
    d.ts, d.returnCode, d.readingCode, d.previousReturnCode || "", d.handle || "", d.soul, d.magnitude,
